...
namespace com.etsoo.MicrosoftApi.Auth
{
    public interface IMicrosoftAuthClient : IAuthClient
    {
        ...
        ValueTask<MicrosoftTokenData?> CreateTokenAsync(string action, string code);
        ...
        Task<(IActionResult result, MicrosoftTokenData? tokenData)> ValidateAuthAsync(HttpRequest request, Func<string, bool> stateCallback, string? action = null);
    }
}
